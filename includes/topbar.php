<header class="topbar glass">
  ...
  <div class="search-wrap"><i class="bi bi-search"></i><input id="globalSearch" class="form-control" placeholder="Search"></div>
  <div class="ms-auto d-flex gap-2 align-items-center">
    ...
    <div class="dropdown">
      <button class="btn btn-primary btn-sm dropdown-toggle" data-bs-toggle="dropdown"><?= e($_SESSION['user']['name'] ?? 'Guest') ?></button>
      <ul class="dropdown-menu dropdown-menu-end">
        <li><span class="dropdown-item-text text-muted"><?= e($_SESSION['user']['role'] ?? '') ?></span></li>
        <li><a class="dropdown-item" href="/modules/settings/index.php">Settings</a></li>
